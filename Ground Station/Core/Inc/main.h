...
/* USER CODE BEGIN EFP */
void print_PC(uint8_t *rx_Buff);  //send to PC
...
#define TX_BUFF_SIZE_RM92A 8  // buffer size send to main3
#define RX_BUFF_SIZE_PC 2  // buffer size receive from RM92A(uplink)
#define RX_BUFF_SIZE_RM92A 39  // buffer size receive from main3

#define LAT_OFFSET 130
#define LON_OFFSET 33
